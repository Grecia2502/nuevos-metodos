...
public class ComponentesNew extends JFrame{
    ...
    public void AddComponentes(JPanel panel1){
       ...
       // Configuración de los JCheckBox
        check1.setBounds(10, 170, 100, 30); //Grecia Ramos se agrega las coordendas en JCheckbox para conectarlo al panel
        check1.setText("Check 1");
        panel1.add(check1);

        //Grecia Ramos se agrega las coordendas en JCheckbox 2 para conectarlo al panel
       ...
       // combolista.setBounds(WIDTH, WIDTH, WIDTH, HEIGHT); 
        combolista.setBounds(10, 210, 150, 30); //Grecia Ramos se agrega las coordendas en Jcombobox para conectarlo al panel
